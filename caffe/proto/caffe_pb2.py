...
_REGIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='classes', full_name='caffe.RegionParameter.classes', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='coords', full_name='caffe.RegionParameter.coords', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='boxes_of_each_grid', full_name='caffe.RegionParameter.boxes_of_each_grid', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='softmax', full_name='caffe.RegionParameter.softmax', index=3,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reorg_param', full_name='caffe.LayerParameter.reorg_param', index=56,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='region_param', full_name='caffe.LayerParameter.region_param', index=57,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bmnet_param', full_name='caffe.LayerParameter.bmnet_param', index=70,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='upsample_param', full_name='caffe.LayerParameter.upsample_param', index=71,
...
_UPSAMPLEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='caffe.UpsampleParameter.size', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BMNETPARAMETER = _descriptor.Descriptor(
  name='BMNetParameter',
  full_name='caffe.BMNetParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_shape', full_name='caffe.BMNetParameter.input_shape', index=0,
      number=3, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='in_threshold', full_name='caffe.BMNetParameter.in_threshold', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bmodel', full_name='caffe.BMNetParameter.bmodel', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output_shape', full_name='caffe.BMNetParameter.output_shape', index=3,
      number=8, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONVOLUTIONPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_winograd', full_name='caffe.ConvolutionParameter.use_winograd', index=18,
      number=19, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INPUTPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='enable_quantize', full_name='caffe.InputParameter.enable_quantize', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RECURRENTPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='time_step', full_name='caffe.RecurrentParameter.time_step', index=5,
      number=6, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SCALEPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='div_term', full_name='caffe.ScaleParameter.div_term', index=5,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_V1LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='crop_param', full_name='caffe.V1LayerParameter.crop_param', index=17,
      number=144, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PADPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='caffe.PadParameter.value', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pads', full_name='caffe.PadParameter.pads', index=1,
...
_LAYERPARAMETER.fields_by_name['bmnet_param'].message_type = _BMNETPARAMETER
...
_BMNETPARAMETER.fields_by_name['input_shape'].message_type = _BLOBSHAPE
_BMNETPARAMETER.fields_by_name['output_shape'].message_type = _BLOBSHAPE
...
DESCRIPTOR.message_types_by_name['BMNetParameter'] = _BMNETPARAMETER
...
BMNetParameter = _reflection.GeneratedProtocolMessageType('BMNetParameter', (_message.Message,), dict(
  DESCRIPTOR = _BMNETPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.BMNetParameter)
  ))
_sym_db.RegisterMessage(BMNetParameter)
...
_PADPARAMETER.fields_by_name['pads'].has_options = True
_PADPARAMETER.fields_by_name['pads']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
